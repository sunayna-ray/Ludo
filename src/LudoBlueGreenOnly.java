...
/*<applet code="LudoBlueGreenOnly" width="300" height="400"></applet>*/
public class LudoBlueGreenOnly extends Applet implements ActionListener
{	
    ...
    {
		setBoard(1);
		tg.setText(valg+"");tb.setText(valb+"");
		paintGreen();
		paintBlue();
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		chance++;
		repaint();
		if(count_piece_blue==4 && count_piece_green==4){
			B2Listen a=new B2Listen();
	...
	public void paintGreen(){
		...
		if(valg==56){
			...
			if(count_piece_green==4){
				...
				current_green=0;count_piece_blue=0;
				current_green=0;
				current_blue=0;
				valg=0;
				valb=0;
