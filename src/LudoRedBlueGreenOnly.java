...
/*<applet code="LudoRedBlueGreenOnly" width="300" height="400"></applet>*/
public class LudoRedBlueGreenOnly extends Applet implements ActionListener
{	
    ...
    {
		setBoard(1);
		tg.setText(valg+"");tb.setText(valb+"");tr.setText(valr+"");
		paintGreen();
		paintBlue();
		paintRed();
		tgc.setText(count_piece_green+"");tbc.setText(count_piece_blue+"");trc.setText(count_piece_red+"");
		setPieces();
    }
	public void actionPerformed(ActionEvent ae)
	{
	...
	public void paintGreen(){
		...
		if(valg==56){
			...
			if(count_piece_green==4){
				...
				count_piece_green=0;count_piece_blue=0;count_piece_red=0;
				current_green=0;current_blue=0;current_red=0;
				valg=0;valb=0;valr=0;
				chance=0;
				bb.setLabel("DICE");
